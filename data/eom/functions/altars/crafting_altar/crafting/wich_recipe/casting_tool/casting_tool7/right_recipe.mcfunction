...
data modify entity @s Item.tag.Spells append value starfall
function eom:altars/crafting_altar/crafting/wich_recipe/casting_tool/array_cycling/array_front_to_back
data modify entity @s Item.tag.display.Lore prepend value '[{"text":"Spell: [","color":"gray","italic":false},{"text":"Starfall","color":"#F7FFAD","italic":false},{"text":"]","color":"gray","italic":false}]'
