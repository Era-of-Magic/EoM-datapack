...
data merge storage eom:static_crafter {Recipe:{Item1:["minecraft:nether_star"],Item2:["minecraft:raw_gold_block"],Item3:["minecraft:jigsaw","light_gem"],Item4:["minecraft:jigsaw","earth_gem"]}}
...
execute if entity @s[scores={temp=1}] run loot spawn ~ ~.3 ~ loot eom:items/spell_scrolls/starfall_scroll
