...
execute if score temp temp matches 1 run scoreboard players set new.page page 2130000
...
execute store success score temp temp run clear @s structure_void{Page:"fireball"}
execute if score temp temp matches 1 if entity @s[scores={researchpoints=1..}] run function eom:custom_blocks/skill_table/functionality/pages/research/spells/fire/unlock/fireball
