...
execute store success score temp temp run clear @s structure_void{Page:"freeze"}
execute if score temp temp matches 1 if entity @s[scores={researchpoints=1..}] run function eom:custom_blocks/skill_table/functionality/pages/research/spells/ice/unlock/freeze
