...
item replace block ~ ~-1 ~ container.18 with structure_void{display:{Name:'{"text":"back","color":"red","italic": false}',Lore:['{"text":""}','[{"text":"Current Page: ","color":"gray"},{"text":"Void Element Spell Research","color":"white"}]']},CustomModelData:100100,Page:"back"}
