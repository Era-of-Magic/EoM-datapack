...
# mana cost
scoreboard players set manacost mana 7
function eom:mana/mana_calculations

execute anchored eyes positioned ^ ^-.3 ^.5 if score enough_mana mana matches 1.. run function eom:spells/freeze/create_spell
